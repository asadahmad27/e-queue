import React, {
	useState, useContext, useCallback, useEffect, useMemo, createContext,
} from 'react';
...
const Container = ({children}: ContainerProps) => {
	...
	const registerPanel = useCallback((label: string, icon?: React.ElementType) => {
		setState(current => ({
	...
	const setActivePanel = useCallback((label: string) => () => {
		setState(current => ({
			...current,
			activePanel: label,
		}));
